...
My research focuses on self-supervised and multimodal learning approaches that integrate temporal data, such as eye gaze and videos, to improve predictive performance in clinical settings. My broader interests include reinforcement learning, representation learning, and multimodality.
...
In my spare time, I like to play the piano, go for a run, and <a href="books">read books</a>.
